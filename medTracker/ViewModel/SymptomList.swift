...
class SymptomList : ObservableObject {
    @Published var symptoms = [
        ...
        Symptom(id: 3, nombre: "Insomnio", description: "Este es un ejemplo de descripción mediano, es decir, con esto está bien.", cuantitativo: false, unidades: "", activo: false, color: ""),
